    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto space-y-12">
          <div>
            <h1 className="font-serif text-3xl text-foreground mb-2">Reviewer Management</h1>
            <p className="text-sm font-sans text-muted-foreground">
              Manage your journal reviewer team and send invitations.
            </p>
          </div>

          <div className="border border-border bg-card p-6">
            <h2 className="font-serif text-xl text-foreground mb-4">Invite New Reviewer</h2>
          ...
          <div className="border border-border bg-card p-6">
            <h2 className="font-serif text-xl text-foreground mb-4">Reviewer Invite History</h2>
            {loading ? (
              <p className="text-muted-foreground animate-pulse">Loading...</p>
            ) : invitations.length === 0 ? (
              <p className="text-muted-foreground text-sm">No invitation records.</p>
            ) : (
          ...
          <div className="border border-border bg-card p-6">
            <h2 className="font-serif text-xl text-foreground mb-4">Active Reviewers</h2>
            {loading ? (
              <p className="text-muted-foreground animate-pulse">Loading...</p>
            ) : reviewers.length === 0 ? (
